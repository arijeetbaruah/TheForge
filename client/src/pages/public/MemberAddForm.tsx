...
class MemberAddForm extends React.Component<MemberAddFormProps, MemberAddFormState> {
    constructor(props: MemberAddFormProps) {
        super(props);
        this.state = {
            form: { ...initMember },
            errors: {},
                ...
                <div className="mef-overlay" onClick={(e) => e.target === e.currentTarget && onCancel()}>
                    <div className="mef-sheet" role="dialog" aria-modal="true" aria-label="Edit member">
                        ...
                        <div className="mef-header">
                            <h2 className="mef-title">Add Member</h2>
